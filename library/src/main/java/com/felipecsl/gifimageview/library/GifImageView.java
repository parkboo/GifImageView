...
public class GifImageView extends ImageView implements Runnable {
    ...
    private OnLastFramePlayed onLastFramePlayedListener = null;
    ...
    public void run() {
        ...
        do {
            ...
            try {
                ...
                int currentFrame = gifDecoder.getCurrentFrameIndex();
                int frames = gifDecoder.getFrameCount();
    ...
    public void setOnLastFramePlayListener(OnLastFramePlayed onLastFramePlayedListener) {
        this.onLastFramePlayedListener = onLastFramePlayedListener;
    }
    ...
    public interface OnLastFramePlayed {
        void onLastFramePlayed();
    }
